...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { code: @template.code, name: @template.name, screen_type: @template.screen_type } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { code: @template.code, name: @template.name, screen_type: @template.screen_type } }
